...
from apps.services.auth import get_current_user_admin, get_current_user_vip_client
from apps.services.post import add_post_worker, get_posts_premium_worker, delete_post_worker, get_posts_worker
